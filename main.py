...
if __name__ == '__main__':
    ...
    checkpoint_cb = ModelCheckpoint(
        ...
        '_epoch({epoch:02d})_step({step:04d})_R1[{sf_val/R1:.4f}]_R5[{sf_val/R5:.4f}]',
    ...
    trainer = pl.Trainer(
        ...
        default_root_dir=f'./LOGS/best_models/{model.encoder_arch}', # Tensorflow can be used to viz 
