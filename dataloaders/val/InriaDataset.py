...
DATASET_ROOT = '/content/drive/MyDrive/geoloc_fcm/geoloc-fcm-gsv-cities/datasets/inria_holidays/' #colab path
# DATASET_ROOT = '/home/USER/work/VPR-Bench/datasets/inria_holidays/'#local path
