...
DATASET_ROOT = '/content/drive/MyDrive/geoloc_fcm/geoloc-fcm-gsv-cities/datasets/Nordland/' #colab path
# DATASET_ROOT = '/home/USER/work/VPR-Bench/datasets/Nordland/' local path
