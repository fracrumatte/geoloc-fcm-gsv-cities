...
DATASET_ROOT = '/content/drive/MyDrive/geoloc_fcm/geoloc-fcm-gsv-cities/datasets/Pittsburgh/' # colab path
# DATASET_ROOT = '/home/USER/work/datasets/Pittsburgh/' local path
