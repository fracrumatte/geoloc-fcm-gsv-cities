...
DATASET_ROOT = '/content/drive/MyDrive/geoloc_fcm/geoloc-fcm-gsv-cities/datasets/ESSEX3IN1_dataset/' #colab path
# DATASET_ROOT = '/home/USER/work/VPR-Bench/datasets/ESSEX3IN1_dataset/'#local path 
