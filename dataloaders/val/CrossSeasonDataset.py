...
DATASET_ROOT = '/content/drive/MyDrive/geoloc_fcm/geoloc-fcm-gsv-cities/datasets/CrossSeason_CoHOG_Dataset/'
# DATASET_ROOT = '/home/USER/work/VPR-Bench/datasets/CrossSeason_CoHOG_Dataset/' #local path 
