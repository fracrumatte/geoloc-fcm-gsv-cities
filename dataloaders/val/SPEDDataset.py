...
DATASET_ROOT = '/content/drive/MyDrive/geoloc_fcm/geoloc-fcm-gsv-cities/datasets/SPED' #colab path
# DATASET_ROOT = '/home/USER/work/VPR-Bench/datasets/SPEDTEST/' local path
